# NumPy A to Z — The Complete Reference Notebook
...
cd <this-repo-folder>
pip install numpy jupyter # If you do not want to use jupyter you can use google colab for free
...
using practical examples like exam marks and temperatures, then backs
